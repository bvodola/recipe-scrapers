...
from bvodola_recipe_scrapers.ohsheglows import OhSheGlows
...
class TestOhSheGlowsScraper(ScraperTest):
    ...
    def test_yields(self):
        self.assertEqual("8 (1/2-cup) servings", self.harvester_class.yields())
